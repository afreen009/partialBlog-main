            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  //this is the place we are sharing it from, what are we going integrate ? the reciever intent right ?
                  //yes, i mean last time we were able to send it to whats app, but on press of the link, it should come back
                  //to app okay noted let go on the github repository to check the code first ok
                  Positioned(
                      left: 0,
                      top: 10,
